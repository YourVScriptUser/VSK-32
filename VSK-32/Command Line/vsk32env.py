...
if command == "WriteVMDisk":
    with open("VM_DISK/vmdisk.img", "wb") as f:
    ...
    with open("M_DUMP/dump.bin", "wb") as f:
    ...
    with open("VM_BIOS/bios.rom", "wb") as f:
